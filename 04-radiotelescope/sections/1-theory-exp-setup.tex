...
When the nucleus and the electron are in the ground state, neutral hydrogen can exist in two states: either the electron and proton spins are aligned (state $F=1$), or they're opposite (state $F=0$).
...
\end{figure}
When observing the radio signal from distant hydrogen clouds in the Milky Way, the angular velocity of the outer branches of the Milky Way can be calculated by the Doppler shift of the HI line.
