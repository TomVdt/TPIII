...
\begin{figure}[htbp]
    ...
    \caption{Current-Voltage curves measured over the metal-semiconductor junction at temperatures ranging from $(124 \pm 3)$ K to $(296 \pm 1)$ K and related fits. \hl{TODO: marges figures}}
    \label{fig:iv-curves}
\end{figure}
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=1]{figures/iv-schottky-potential-temperature.pdf}
    \caption{Schottky barrier height $\Phi_b$ as a function of temperature as obtained by I-V curves blabla. \hl{TODO: side by side with fig 2}}
