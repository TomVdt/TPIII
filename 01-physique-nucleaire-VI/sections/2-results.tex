...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.495\textwidth}
        \fbox{\includegraphics[scale=1]{figures/lowmean_poisson.pdf}}
    \end{subfigure}
    \begin{subfigure}{0.495\textwidth}
        \fbox{\includegraphics[scale=1]{figures/lowmean_gaussian.pdf}}
    \end{subfigure}
    \begin{subfigure}{0.495\textwidth}
        \fbox{\includegraphics[scale=1]{figures/highmean_poisson.pdf}}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.495\textwidth}
        \fbox{\includegraphics[scale=1]{figures/highmean_gaussian.pdf}}
    \end{subfigure}
\end{figure}
