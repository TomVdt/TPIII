...
It was discussed in \autoref{sec:statistics} that the number of desintegrations detected 
...
in \autoref{sec:coincidences} allows for the calculation
...
\begin{figure}[htbp]
    ...
    selector, as described by \autoref{eq:coincidence_time_resolution}. The $y$-intercept of the fit was ignored to follow the equation.}
