...
TODO: add small description of \cobalt decay?
Overdetailed description of EC?
Necessaire de mettre l'ionisation / stopped by \_\_\_?

ANSWER: bonne idée la description du \cobalt, de plus que ça permet 
de donner déja en Annexe le schéma.
EC peut etre pas si overdetailed que ça si tu considère que le \cobalt se desintegre par EC.
Absolument d'accord que ionisation et attenuation pas nécessaires, ils vont être
les premieres parties à partir lorsqu'on a un rapport de 17 pages.
