...
\begin{itemize}
    ...
    \hl{These particles, accordingly called $\alpha$ particles, are the most energetic between the three forms of radiation (with typical energies of about 5 MeV), but also the least penetrating, being able to be stopped by a sheet of paper.}
    %
    ...
    \hl{The electron comes most often from the inner $K$-shell, resulting in the outer electrons cascading down to fill the lower levels and emitting [one or more] X-rays}\cite{intro_nuclear_particle_physics}.
    \hl{Of smaller ionising power than $\alpha$ radiation, $\beta$ radiation is however more penetrating, requiring aluminium sheets to be stopped.}
    %
    ...
    \hl{The typical energies of nuclear $\gamma$ rays range from a fraction to several MeV 
...
or two successive ones ($\gamma_2$ and $\gamma_3$) in 88\% of cases \cite{notice_VI}.
...
\begin{itemize}
    ...
    \item The scintillator has a finite energy resolution, such that all energy peaks in the $\gamma$ spectrum form gaussian curves rather than discrete lines. \hl{The width of this distribution is a measure of the energy resolution of the
    detector}
\end{itemize}
