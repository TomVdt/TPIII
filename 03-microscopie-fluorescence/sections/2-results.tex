...
A set of 100 images of the fluorescent 0.1 $\mu$m beads was \hl{were} acquired for each of the laser wavelengths.
An isolated bead was selected and its intensity profile was fitted in all images with a two-dimensional \hl{G}aussian curve. 
...
\subsection{Mitochondria} \label{sec:results_mitochondria}
...
\hl{TODO for TOM: remesurer tout ca, j'ai mesuré la largeur et pas le cross-section et c'est le cross section qui est important}
%
% \begin{figure}
%     \begin{subfigure}{0.32\textwidth}
...
\subsection{Clathrin} \label{sec:results_clathrin}
