...
\usepackage[autostyle=true,english=american]{csquotes}  % QuOtE
...
\usepackage[backend=biber, autolang=other, style=ieee, url=false, sorting=none]{biblatex}  % Citing
\usepackage{appendix}  % Fancy appendix

\usepackage[colorlinks,bookmarks=true,linkcolor=black,urlcolor=blue,citecolor=black]{hyperref}  % Hyperlinks
