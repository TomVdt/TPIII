...
\begin{frame}{Hysteresis}
    \begin{itemize}
        ...
        \item Caused by impurities \footfullcite{hassouba_analysis_2013} OR BETTER: contamination layer on the probe surface \footfullcite{hirao_critical_1972} \footfullcite{oyama_systematic_1976}
    \end{itemize}
    \begin{center}
