...
{  % load bearing curly brace, do not remove
\usebackgroundtemplate{\includegraphics[height=\paperheight]{../figures/bartolomeo.jpg}}
\setbeamercolor{normal text}{fg=white}
\setbeamercolor{footnote}{bg=black, fg=white}
\setbeamercolor{footnote mark}{bg=black, fg=white}
...
\begin{frame}[t]{Introduction}
    ...
    \begin{columns}
        \column{0.5\textwidth}
        \begin{itemize}
            \item Probes used on NorSat-1 \footfullcite{hoang_multi-needle_2018}
            \item Study of ionosphere \footfullcite{hoang_multi-needle_2018}
            \item Currently being added to ISS 
        \end{itemize}

        \column{0.5\textwidth}
    \end{columns}
    \footnotetext{\colorbox{black}{\emph{Bartolomeo connected to Columbus}, ESA/NASA, ESA Standard License}}
