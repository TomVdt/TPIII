...
\begin{frame}{Estimating temperature}{$p = feur$, $I_\text{filament} = truc$, $V_\text{filament}$, $V_\text{grid} = chose$}
    \begin{columns}
        \column{0.5\textwidth}
        \centering
...
\begin{frame}{Establishing the dispersion relation}{$p = feur$, $I_\text{filament} = truc$, $V_\text{filament}$, $V_\text{grid} = chose$}
    \begin{columns}
        \column{0.5\textwidth}
        \centering
        \vspace{-1cm}
